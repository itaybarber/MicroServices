...
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken")); // We want to decode our JWT
...
var currentUser = function (req, res, next) {
    var _a;
    if (!((_a = req.session) === null || _a === void 0 ? void 0 : _a.jwt)) { // checking if there's no session or if there's no jwt prop
        return next();
    }
    try {
